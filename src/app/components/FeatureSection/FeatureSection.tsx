...
const FeatureSection = () => {
  return (
    <div className="">
      <div className="relative px-4 md:px-10 mt-40 md:mt-0 flex items-center justify-center Feature-section">
        ...
        <div className="">
          <div className="flex flex-col md:gap-10 lg:gap-0 custom-mobile:flex-row items-center justify-between space-y-10 md:space-y-0 lg:space-x-16 w-full mx-auto">
            ...
            <div className="flex flex-col items-center card bg-white/80 shadow-lg p-4 rounded-md text-center w-[16rem] lg:w-48 h-40 md:h-56 ">
              <svg
                width="40"
                height="40"
                viewBox="0 0 40 40"
            ...
            <div className="flex flex-col items-center card bg-white/80 shadow-lg p-4 rounded-md text-center w-[16rem] lg:w-48 h-40 md:h-56">
              ...
              >
                <path
                  d="M12 6h16M20 6v20M14 26c0 4 4 8 6 8s6-4 6-8V10H14v16z"
                  stroke="#3a8fff"
                  strokeWidth="3"
                  fill="none"
                  strokeLinecap="round"
              ...
              <p className="text-custom-gray text-sm md:text-base leading-6 text-center">
                <span className="font-semibold">Inert</span> to most substances
            ...
            <div className="flex flex-col items-center card bg-white/80 shadow-lg p-4 rounded-md text-center w-[16rem] lg:w-48 h-40 md:h-56">
              ...
              >
                <path
                  d="M20 10v20M10 30c0-5 10-5 10-10V10"
                  stroke="#3a8fff"
                  strokeWidth="3"
                  fill="none"
                  strokeLinecap="round"
            ...
            <div className="flex flex-col items-center card bg-white/80 shadow-lg p-4 rounded-md text-center w-[16rem] lg:w-48 h-40 md:h-56">
              ...
              >
                ...
                />
                <path
                  d="M20 10v10M20 20l-5 10M20 20l5 10"
                  stroke="#3a8fff"
                  strokeWidth="3"
                  strokeLinecap="round"
                />
