      ...
      <div className="relative px-4 md:px-10 mt-[10rem] md:mt-0 flex items-center justify-center Feature-section">
        ...
        <div className="">
          <div className="flex flex-col md:gap-10 lg:gap-0 custom-mobile:flex-row items-center justify-between space-y-10 md:space-y-0 lg:space-x-16 w-full mx-auto">
            ...
            <div className="flex flex-col items-center card bg-white opacity-80 shadow-lg p-6 rounded-md text-center w-[20rem] lg:w-60 h-[12rem] md:h-72 ">
              <svg
              ...
              >
                <defs>
                  ...
                  >
                    <stop
                      offset="0%"
                      style={{ stopColor: "#009ffd", stopOpacity: 1 }}
                    />
                    <stop
                      offset="100%"
                      style={{ stopColor: "#2a2a72", stopOpacity: 1 }}
                    />
                  </linearGradient>
                </defs>
            ...
            <div className="flex flex-col items-center card bg-white opacity-80 shadow-lg p-6 rounded-md text-center w-[20rem] lg:w-60 h-[12rem] md:h-72">
              ...
              <p className="text-custom-gray text-sm md:text-base leading-6 text-center">
                High dielectric constant and consequently high electric
